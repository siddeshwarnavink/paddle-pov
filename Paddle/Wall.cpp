...
namespace Paddle {
	...
	void Wall::CreateVertexBuffer() {
		...
		device.createBuffer(
			...
			vertexBuffer,
			vertexBufferMemory);
		device.SetObjectName((uint64_t)vertexBuffer, VK_OBJECT_TYPE_BUFFER, "Wall Vertex Buffer");
		void* data;
	...
	void Wall::CreateIndexBuffer() {
		...
		device.createBuffer(
			...
			indexBuffer,
			indexBufferMemory);
		device.SetObjectName((uint64_t)indexBuffer, VK_OBJECT_TYPE_BUFFER, "Wall Index Buffer");
		void* data;
